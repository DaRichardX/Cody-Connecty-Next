    ...
    <>
      <div className="in-person-classes-container">
        ...
        <div className="in-person-classes-container1">
          <h1 className="in-person-classes-notice">
            Registration is currently closed; Program signups available after
            Aug 14th
          </h1>
        </div>
            ...
            <div className="in-person-classes-container3">
              <div className="in-person-classes-feature-card">
                ...
                <span className="in-person-classes-text02">
                  <span>
                    provides a basic coding experience to youth who are
                    interested in the world of coding. Utilizing the versatile
                    and user-friendly language of Python, students will learn
                    the foundational concepts and skills of programming through
                  ...
                  <br></br>
                  <span>
                    Our Volunteer instructors will guide them through the
                    process, allowing them to not only gain a solid
                    understanding of coding, but also have fun while doing it.
                    Join us in this journey of discovery and unleash the
            ...
            <div className="in-person-classes-container4">
              <div className="in-person-classes-feature-card3">
                <svg
                  ...
                  className="in-person-classes-icon2"
                >
                ...
                <h2 className="in-person-classes-text34">
                  Intermediate Coding
                </h2>
                <span className="in-person-classes-text35">
                  <span>
                    Take your coding skills to the next level with our
                    Intermediate Coding class! Building on the foundations
                    learned in our Introduction to Coding class, students will
                    delve deeper into the capabilities of Python and explore
                  ...
                  <span>
                    ...
                    opportunity to expand their knowledge and improve their
                    coding proficiency.
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                  ...
                  <br></br>
                  <span>
                    With a combination of individual and group projects,
                    students will have the opportunity to apply their skills in
                    real-world scenarios and work on more complex tasks. Join us
                    and take the next step towards becoming a proficient coder!
                  </span>
                </span>
              </div>
        ...
        <div className="in-person-classes-banner">
          ...
          <button className="in-person-classes-button button">
            Learn more
          </button>
        </div>
      ...
      <style jsx>
        {`
          ...
          .in-person-classes-container3 {
            display: grid;
            grid-template-rows: 1fr;
          }
          .in-person-classes-feature-card {
            width: 100%;
            display: flex;
            max-width: var(--dl-size-size-maxwidth);
            align-items: flex-start;
          ...
          .in-person-classes-icon {
            fill: var(--dl-color-gray-500);
            width: 2rem;
            height: 2rem;
            margin-bottom: var(--dl-space-space-unit);
          }
          .in-person-classes-text01 {
            font-weight: 600;
            margin-bottom: var(--dl-space-space-unit);
          }
          ...
          .in-person-classes-link:hover {
            color: var(--dl-color-gray-white);
            background-color: var(--dl-color-gray-black);
          }
          .in-person-classes-container4 {
            display: grid;
            grid-template-rows: 1fr;
          }
          .in-person-classes-feature-card3 {
            width: 100%;
            display: flex;
            max-width: var(--dl-size-size-maxwidth);
            align-items: flex-start;
          ...
          .in-person-classes-icon2 {
            width: 2rem;
            height: 2rem;
            margin-bottom: var(--dl-space-space-unit);
          }
          .in-person-classes-text34 {
            font-weight: 600;
            margin-bottom: var(--dl-space-space-unit);
          }
          ...
          .in-person-classes-link1:hover {
            color: var(--dl-color-gray-white);
            background-color: var(--dl-color-gray-black);
          }
          .in-person-classes-container5 {
            flex: 0 0 auto;
            width: auto;
            height: 100%;
            display: flex;
          ...
          .in-person-classes-text64 {
            text-align: center;
            font-weight: 600;
            margin-bottom: var(--dl-space-space-twounits);
          }
          .in-person-classes-text65 {
            font-weight: 600;
          }
          .in-person-classes-text66 {
            font-weight: 600;
          }
          .in-person-classes-button {
            transition: 0.3s;
            padding-top: var(--dl-space-space-halfunit);
            padding-left: var(--dl-space-space-threeunits);
            padding-right: var(--dl-space-space-threeunits);
          ...
          .in-person-classes-button:hover {
            color: var(--dl-color-gray-white);
            background-color: var(--dl-color-gray-black);
          }
